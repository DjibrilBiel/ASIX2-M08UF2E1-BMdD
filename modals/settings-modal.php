  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md">
    <div class="modal-content">
      <div class="modal-header rounded-0">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Configuración de Datos de Facturación</h1>
            ...
            <form action="./?action=update_settings" id="settings-form" method="POST">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <label for="store_address" class="form-label">Dirección de la Tienda</label>
                        ...
                        <div class="mb-3">
                            <label for="store_contact" class="form-label">Contacto de la Tienda</label>
                        ...
                        <div class="mb-3">
                            <label for="store_contact" class="form-label">Nota al Pie de Página</label>
