        ...
        <div class="card shadow">
            <div class="card-header rounded-0">
                <div class="d-flex w-100 justify-content-end align-items-center">
                    <button class="btn btn-sm rounded-0 btn-primary" type="button" id="add_student"><i class="far fa-plus-square"></i> Añadir Nuevo</button>
                </div>
            </div>
                        ...
                        <table class="table table-bordered table-hovered table-stripped">
                            ...
                            <thead class="bg-dark-subtle">
                                <tr class="bg-transparent">
                                    ...
                                    <th class="bg-transparent text-center">Nombre de la Clase - Asignatura</th>
                                    <th class="bg-transparent text-center">Nombre</th>
                                    <th class="bg-transparent text-center">Accionar</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <th class="text-center px-2 py-1" colspan="4">No se encontraron datos.</th>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
