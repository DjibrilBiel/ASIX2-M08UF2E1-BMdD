        ...
        <div class="card shadow">
            <div class="card-header rounded-0">
                <div class="d-flex w-100 justify-content-end align-items-center">
                    <button class="btn btn-sm rounded-0 btn-primary" type="button" id="add_class"><i class="far fa-plus-square"></i> Añadir Nuevo</button>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hovered table-stripped">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <th class="text-center px-2 py-1" colspan="3">No se encontraron datos.</th>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
